...
function activate(context) {
    ...
    function textCallBack(pre) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (editor) {
                ...
                console.log(fileType, createWebviewPanel_1.webviewPanel.panel, pre, 'fileType', (_a = sidebarProvider._view) === null || _a === void 0 ? void 0 : _a.webview);
            }
            if (!selectedText) {
            ...
            if (configuration.get('direction', 'right') === 'right') {
                if (!createWebviewPanel_1.webviewPanel.panel) {
                    ...
                    ((_b = createWebviewPanel_1.webviewPanel.panel) === null || _b === void 0 ? void 0 : _b.webview) && (0, handleMessage_1.sendSelectedText)(context, (_c = createWebviewPanel_1.webviewPanel.panel) === null || _c === void 0 ? void 0 : _c.webview, value, textType);
                }
            }
            else {
                if (sidebarProvider._view) {
                    (_e = (_d = sidebarProvider._view).show) === null || _e === void 0 ? void 0 : _e.call(_d, true);
                    (0, handleMessage_1.sendSelectedText)(context, (_f = sidebarProvider._view) === null || _f === void 0 ? void 0 : _f.webview, value, textType);
                }
                else {
                    yield vscode.commands.executeCommand("chatgpt-china.focus");
                    (0, handleMessage_1.sendSelectedText)(context, undefined, value, textType);
                }
            }
        });
    ...
    context.subscriptions.push(vscode.commands.registerCommand('extension.chat.openWebview', () => __awaiter(this, void 0, void 0, function* () {
        ...
        // 	return;
        // }
        // const codeSnippet = new vscode.SnippetString('console.log(${1:"Hello, world!"});');
    ...
    // context.subscriptions.push(openWebview(context));
    // // 优化代码 中文回答
    // context.subscriptions.push(chatMoss0ptimize(context));
    // // 解释这段代码 中文回答
    // context.subscriptions.push(chatMossExplain(context));
    // // 说明这段代码可能存在的问题 中文回答
    // context.subscriptions.push(chatMossBugCcan(context));
