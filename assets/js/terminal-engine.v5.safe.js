/**
 * =========================================================
 * YISHEN GLOBAL — SOVEREIGN TERMINAL ENGINE V5 (SAFE EDITION)
 * ---------------------------------------------------------
 * Status: EXPERIMENTAL / TACTICAL MODULE
 * Role: Command Simulation / HS Intelligence / UI Terminal
 * Policy:
 *  - NOT part of Genesis LOCKED core
 *  - Safe to disable without affecting site power-on
 *  - Zero build / zero backend / zero dependency
 * =========================================================
 */
...
const GLOBAL_HS_DB = Array.isArray([
...
/* ==========================================
   2. SOVEREIGN TERMINAL CORE (SAFE)
   ========================================== */
        ...
        if (this.loadingScreen) {
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    console.log(
                        "%c> YISHEN_SOVEREIGN_TERMINAL_V5_READY",
